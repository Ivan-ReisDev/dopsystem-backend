...
TeamsRouter.route('/teams/create').post(authGuard(['Admin']),(req, res) => serviceControllerTeams.createTeams(req, res));
TeamsRouter.route('/teams/update/').put(authGuard(['Admin']),(req, res) => serviceControllerTeams.updateTeams(req, res))
...
TeamsRouter.route('/teams/delete').delete(authGuard(['Admin']),(req, res) => serviceControllerTeams.deleteTeams(req, res))
